    ...
    return (
        <div className="bg-yellow-200 m-5 rounded-3xl grid grid-rows-3 text-center h-full">
            <div className="grid grid-cols-3">
                <div></div>
                <div>
                    <p className="text-6xl text-amber-700 font-Oswald pt-2">S I G N I N </p>
                </div>
                <div className = "text-amber-700">
                    <button onClick={aboutHandler} className="text-lg font-semibold pt-1 px-2 cursor-pointer">about</button>
                     |
                    <button onClick={signupHandler} className="text-lg font-semibold px-2 cursor-pointer">sign up</button>
                     |
            ...
            <div className="m-1">
                <p onClick={passwordForgot} className="text-lg text-amber-700 font-semibold cursor-pointer mx-96 my-3">forgot password</p>  
            </div>
        </div>
    )
} 
